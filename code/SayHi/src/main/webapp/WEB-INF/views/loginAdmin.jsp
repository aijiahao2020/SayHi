...
<div id="head">
 ...
 <div id="bottom">
      ...
      <div id="bottom_account">账号:<input id="bottom_account_input" type="text" name="adminName" value="${requestScope.admin.adminName }"></div>
      <div id="bottom_password">密码:<input id="bottom_password_input" type="password" name="password"></div>
      <c:if test="${!empty requestScope.message }">
		<center><font color="red">${requestScope.message }</font></center>
	  </c:if>
